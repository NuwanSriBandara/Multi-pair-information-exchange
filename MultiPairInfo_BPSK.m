...
hc1 = sqrt(d1^-eta)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
hc2 = sqrt(d2^-eta)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
hc3 = sqrt(d3^-eta)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
hc4 = sqrt(d4^-eta)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
hc5 = sqrt(d5^-eta)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
hc6 = sqrt(d6^-eta)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);

nc1 = sqrt(no)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
nc2 = sqrt(no)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
nc3 = sqrt(no)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
nc4 = sqrt(no)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
nc5 = sqrt(no)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
nc6 = sqrt(no)*(randn(N,1) + 1i*randn(N,1))/sqrt(2);
